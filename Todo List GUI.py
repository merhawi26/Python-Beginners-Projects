...
from gui import task_completed
...
class TodoList:
    def __init__(self):
        ...
        # View task button
        self.view_button=tk.Button(self.window, text="View Task", command= self.view_task)
        self.view_button.pack(pady=5)

        # Mark as Completed button
        self.complete_button=tk.Button(self.window, text="Mark Completed Task", command=self.task_completed)
    ...
    def task_completed(self):
        try:
            with open('Todo.txt','r') as file:
                ...
                completed_task=int(simpledialog.askstring('Task Completed',f"Select a task number : \n{task_list}"))
                ...
                messagebox.showinfo('Success',f"You have completed : {completed_task_desc}")
